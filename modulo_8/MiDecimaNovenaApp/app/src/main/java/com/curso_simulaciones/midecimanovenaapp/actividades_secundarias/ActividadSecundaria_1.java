...
public class ActividadSecundaria_1 extends Activity {
    ...
    private void crearElementosGUI(){
        ...
        textNombre.setBackgroundColor(Color.rgb(100, 30, 22));
        textNombre.setTextSize(TypedValue.COMPLEX_UNIT_SP,2.5f*tamanoLetraResolucionIncluida);
        textNombre.setText("NOMBRE");
        textNombre.setTextColor(Color.rgb(208, 236, 231));
        ...
        imagen.setImageResource(R.drawable.titancolosal);
    }
    private LinearLayout crearGUI(){
        ...
        linearPrincipal.setBackgroundColor(Color.rgb(100, 30, 22));
        ...
        linearArriba.setBackgroundColor(Color.rgb(208, 236, 231));
        ...
        parametro_pegado_linear_arriba.weight = 9.0f;
        ...
        linearAbajo.setBackgroundColor(Color.rgb(208, 236, 231));
        ...
        parametro_pegado_linear_abajo.weight = 1.0f;
        ...
        parametros_pegado_text_view_a_filas_arriba.setMargins(3*a,a,2*a,3*a);
        ...
        parametros_pegado_edit_text_a_filas_arriba.setMargins(2*a,a,3*a,3*a);

        linearAbajo.addView(textNombre, parametros_pegado_text_view_a_filas_arriba);
        linearAbajo.addView(editNombres, parametros_pegado_edit_text_a_filas_arriba);
        ...
        linearArriba.addView(imagen,parametros_pegado_imagen_arriba);
